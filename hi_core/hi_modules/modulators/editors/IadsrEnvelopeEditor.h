...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class IadsrEnvelopeEditor  : public ProcessorEditorBody,
                             public Timer,
                             public SliderListener
{
public:
    //==============================================================================
    IadsrEnvelopeEditor (ProcessorEditor *p);
    ~IadsrEnvelopeEditor();
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (IadsrEnvelopeEditor)
};
